...
function AddImage() {
    ...
    const handleUpload = () => {
        ...
        const storageRef = refStorage(storage, `/banner/${file.name}`);
        ...
        uploadTask.on(
            ...
            () => {
                ...
                const postImage = {
                  ...
                  const newPostKey = push(child(ref(db), `data/banner`)).key;
                  const updates = {};
                  updates[`/data/banner/` + newPostKey] = postImage;
    ...
    <div className="container">
        ...
        <div className="card">
            ...
            <div>
            {file? <><img  src={preview} alt={file.name} style={{width: "400px", borderRadius:"40px"}}/></>: <>
                    <img for="files" src={bannerImage} style={{width: "400px", borderRadius:"40px"}}  /></> }
            </div>
